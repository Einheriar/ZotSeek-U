...
zotseek-pref-brief-test-consent-title = Проверить подключение для литературных обзоров?
zotseek-pref-brief-test-consent-message = Тест отправит провайдеру { $provider } только фиксированный тестовый текст и может привести к небольшой плате за API. Статьи, заметки и пути к файлам не отправляются. Продолжить?
zotseek-pref-brief-consent-message = Для создания обзора ZotSeek отправит провайдеру { $provider } название статьи, аннотацию и текст страниц PDF. При создании шаблонов промптов будут отправлены два шаблона и ваши ответы в форме. Для вашего BYOK-аккаунта может взиматься плата; даже проверка подключения может стоить небольшую сумму. Продолжить?
...
zotseek-brief-usage-heading = Использование токенов по данным провайдера:
zotseek-brief-usage-input = Ввод: { $tokens }
zotseek-brief-usage-output = Вывод: { $tokens }
zotseek-brief-usage-reasoning = Рассуждение: { $tokens } (показано отдельно и повторно не суммируется)
zotseek-brief-usage-total = Всего: { $tokens }
zotseek-brief-usage-total-unavailable = Всего: провайдер не вернул пригодное значение
zotseek-brief-usage-requests = Получены данные об использовании: { $reported } из { $total } запросов
zotseek-brief-usage-incomplete = Ещё { $count } запрос(а/ов) не вернули пригодные данные. Значения могут быть неполными и не являются окончательным счётом.
...
zotseek-brief-preparation-changed = Во время подготовки изменились провайдер, модель или лимит вывода. Запустите создание заново и подтвердите ещё раз.
zotseek-brief-generation-confirm-title = Подтвердить отправку и создание литературных обзоров?
zotseek-brief-generation-confirm-message = Создать обзоры для { $count } статей и отправить названия, аннотации и текст страниц PDF провайдеру { $provider } (модель: { $model }). Оценка ввода: около { $inputTokens } tokens; лимит вывода на запрос: { $outputTokens } tokens; ожидаемый минимум: { $requests } запрос(а/ов). Оценка носит справочный характер. Для BYOK-аккаунта может взиматься плата; окончательные данные и счёт предоставляет провайдер. Продолжить?
