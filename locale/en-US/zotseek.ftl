...
zotseek-pref-notesDesc = Indexes title, abstract, tags, and child notes.
...
zotseek-pref-fullDesc = Indexes title, abstract, tags, child notes, and full PDF content with page numbers.
...
zotseek-pref-autoIndexing = Startup Index Sync
zotseek-pref-autoIndexLabel =
    .label = Check for index changes once when Zotero starts
zotseek-pref-autoIndexDesc = Checks once after startup, then remains idle. ZotSeek does not monitor notes while you edit.
zotseek-pref-checkNow =
    .label = Check for Updates Now
zotseek-pref-checkNowRunning = Checking ZotSeek index
zotseek-pref-checkNowRunningDesc = Comparing Zotero items and notes with the local index…
zotseek-pref-checkNowComplete = Index check complete
...
zotseek-pref-indexScopeAll =
 .label = All libraries
zotseek-pref-indexScopeDesc = Choose which libraries are included in startup and manual update checks.
