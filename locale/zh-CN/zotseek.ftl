...
zotseek-pref-autoIndexing = 启动时同步索引
zotseek-pref-autoIndexLabel =
    .label = 每次 Zotero 启动后检查一次索引变化
zotseek-pref-autoIndexDesc = 启动后检查一次，完成后保持空闲。编辑笔记时 ZotSeek 不监听、不读取，也不执行索引。
zotseek-pref-checkNow =
    .label = 立即检查更新
zotseek-pref-checkNowRunning = 正在检查 ZotSeek 索引
zotseek-pref-checkNowRunningDesc = 正在比较 Zotero 条目、笔记与本地索引……
zotseek-pref-checkNowComplete = 索引检查完成
...
zotseek-pref-indexScopeAll =
 .label = 所有文献库
zotseek-pref-indexScopeDesc = 选择启动检查和手动检查时包含哪些文献库。
