...
zotseek-brief-prompt-wizard-notice = 描述你的閱讀重點與偏好，ZotSeek 將為一般論文以及評論或理論論文產生一對配對提示詞。
...
zotseek-brief-prompt-wizard-status-idle = 準備產生提示詞。
...
zotseek-brief-prompt-wizard-generate = 產生提示詞
...
zotseek-pref-brief-consent-message = 產生簡報時，ZotSeek 會將文獻標題、摘要和 PDF 頁面文字傳送至 Alibaba Bailian；建立提示詞範本時，會傳送兩份範本和你填寫的表單內容。你的 BYOK 帳戶可能產生費用，連線測試也可能產生少量費用。是否繼續？
...
zotseek-brief-collection-confirm-title = 要產生收藏集文獻簡報嗎？
zotseek-brief-collection-confirm-message = 要為 { $count } 篇文獻產生簡報嗎？這可能產生 API 費用。
