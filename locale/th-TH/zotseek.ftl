...
zotseek-pref-indexModeMismatchAction = คลิก “สร้างดัชนีใหม่” ด้านล่างเพื่อใช้การตั้งค่าโหมดดัชนีใหม่
...
zotseek-pref-mcpServerLabel =
    .label = อนุญาตให้ AI agent ค้นหาไลบรารีของคุณ (เซิร์ฟเวอร์ MCP ภายในเครื่อง)
zotseek-pref-mcpServerDesc = ให้ไคลเอนต์ MCP เช่น Claude Code เรียกใช้การค้นหาเชิงความหมายแบบอ่านอย่างเดียวในไลบรารีของคุณ ทุกอย่างอยู่ในคอมพิวเตอร์เครื่องนี้ (เฉพาะ localhost)
...
zotseek-indexing-chunkStrategyRebuildRequired = ZotSeek ตรวจพบว่าดัชนีของโมเดลปัจจุบันใช้กลยุทธ์การแบ่งชิ้นข้อมูลรุ่นเก่า ดัชนีที่มีอยู่ยังค้นหาได้ แต่จะหยุดการอัปเดตส่วนเพิ่มเบื้องหลังเพื่อป้องกันการผสมชิ้นข้อมูลเก่าและใหม่ ใช้ “สร้างดัชนีใหม่” ในการตั้งค่าเพื่อสร้างใหม่ทั้งหมด การปิดประกาศนี้จะไม่เริ่มสร้างใหม่และไม่แก้ไขดัชนีที่มีอยู่

    การดำเนินการนี้อาจใช้เวลาหลายนาทีขึ้นอยู่กับขนาดไลบรารี
